...
// Flip directionality
function opposingDirection(dir) {
    switch (dir) {
        case Direction.NONE:
...
const map0Data = { sp1: { x: 46, y: 20 }, sp2: { x: 53, y: 27 } };
const map1Data = {
    sp1: { x: 43, y: 12 },
    sp2: { x: 56, y: 37 },
    walls: [
...
let Game = /** @class */ (() => {
    class Game {
        ...
        drawScore() {
            ...
            if (!Game.isMP) {
                ...
                ctx.textAlign = "right";
                ctx.fillText(`High-Score: ${Game.highScores[Game.currentMap]}`, canvas.width - 30, 30);
            }
            else {
                // Draw p1 square
                ctx.beginPath();
    ...
    // Render and update
    Game.force_frame = false;
    Game.default_refresh_delay = 100;
    Game.refresh_delay = 100;
    Game.cols = 100;
    Game.rows = 50;
    Game.pixel_size = 10;
    Game.header_size = 50;
...
let Snake = /** @class */ (() => {
    ...
    Snake.color = [Colors.PINK, Colors.GREEN];
    return Snake;
})();
// Food pellet class
